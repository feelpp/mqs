...
int main(int argc, char**argv )
{
  ...
  options.add_options()
    ...
    ( "picard.tol", po::value<double>()->default_value( 1.e-5 ), "picard tol" )
    ( "picard.maxiter", po::value<double>()->default_value( 20 ), "picard maxiter" );
  ...
  double tol = doption(_name="picard.tol");
  Feel::cout << "tol=" << tol << std::endl;
  double maxiter = doption(_name="picard.maxiter");
  Feel::cout << "maxiter=" << maxiter << std::endl;
