...
We can see that the curves stem:[I(t)] and stem:[B(t)] correspond perfectly in the non-linear case when they are normalized to the values of the linear case.
