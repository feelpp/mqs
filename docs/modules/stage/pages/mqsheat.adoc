...
\int_{\Omega} \rho C_p \frac{\partial T}{\partial t} \cdot v + \int_{\Omega} k \nabla T \cdot \nabla v + \int_{\Gamma_R} h T \cdot v = \int_{\Omega_C} \sigma ( \nabla V \cdot \nabla V + 2 \nabla V \cdot \frac{\partial A}{\partial t} + \frac{\partial A}{\partial t} \cdot \frac{\partial A}{\partial t}) \cdot v + \int_{\Gamma_R} h T_w \cdot v - \int_{\Gamma_N} m \cdot v
\end{align*}
++++
