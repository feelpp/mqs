...
++++
\begin{equation*}
\rho Cp\frac{\partial T}{\partial t} - \Delta T = \sigma^3 ( \nabla V \cdot \nabla V + 2 \nabla V \cdot \frac{\partial A}{\partial t} + \frac{\partial A}{\partial t} \cdot \frac{\partial A}{\partial t})
\end{equation*}
++++
