...
in particular, starting and stopping the magnets. Electromagnetic, thermal and mechanical phenomena come into play. Different interactions impose limitations, ...
