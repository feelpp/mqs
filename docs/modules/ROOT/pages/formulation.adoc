...
++++
\begin{equation}
\int_{\Omega} \frac{1}{\mu} \, (\nabla \times \phi) \cdot (\nabla \times A) + \int_{\Gamma_D} \frac{1}{\mu} (\phi \cross (\nabla \times A))\cdot n + \int_{\Gamma_N} \frac{1}{\mu} (\phi \cross (\nabla \times A))\cdot n = - \int_{\Omega} \phi \cdot (\sigma \, \nabla V + \frac{\partial A}{\partial t})
\end{equation}
++++
...
++++
\begin{equation}
\int_{\Omega} \frac{1}{\mu} \, (\nabla \times \phi) \cdot (\nabla \times A) + \int_{\Gamma_D} \frac{1}{\mu} (\phi \cross n) \cdot (\nabla \times A) + \int_{\Gamma_N} \frac{1}{\mu} ((\nabla \times A) \cross n ) \cdot \phi = - \int_{\Omega} \phi \cdot (\sigma \, \nabla V + \frac{\partial A}{\partial t})
\end{equation}
++++

Neumann's conditions dictate that stem:[(\nabla \times A) \cross n = 0] on stem:[\Gamma_N].
