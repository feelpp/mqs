/* -------------------------------------------------------------------
     ...
     To compute the solution: getdp CoreMassive -msh core.msh -solve MagDyn_av_Heat_Axi.pro
  ...
  Function {
    ...
    sigma_linear [ Ind ] = 5.9e7       ;
    sigma [ Ind ] = sigma_linear[] / (1 + Alpha[] * ($1-T_ref)) ;
    k [ Ind ] = 380                             ;
  ...
  Include "MagDyn_av_Heat_Axi.pro"

  PostOperation Map_T UsingPost NL_ThDyn_t_Axi {
    Print[ T, OnElementsOf DomainC_Mag, File "test_MagDyn_T.pos", TimeStep {1:Nbr_Time_Steps}] ;
  }

  PostOperation Map_av UsingPost NL_MagThDyn_t_Axi {
  ...
  PostOperation U_av UsingPost NL_MagThDyn_t_Axi {
...
/*********
  PostOperation U_av UsingPost MagThDyn_t_Axi {
